"""
G1 Mimic Distill Config V6.1 - V6 PARAMS + CUSTOM DATA

Same as V6 (Responsive Teleop) but with custom motion data:
  - c_walk: weight 2.5 (user's walking data)
  - eastworlds_tt, jh, sk_walk: weight 2.0 (virtuals_dataset)
  - TWIST2_full: weight 1.0 (existing dataset)

V6 Strategy (inherited):
...
class G1MimicPrivCfgV6_1(HumanoidMimicCfg):
    ...
    class rewards(HumanoidMimicCfg.rewards):
        ...
        class scales:
            # ================================================================
            # V6.1: Same as V6 - RESPONSIVE TELEOP
            # ================================================================
            ...
            tracking_root_linear_vel = 3.0
            tracking_root_angular_vel = 2.5
    ...
    class motion(HumanoidMimicCfg.motion):
        ...
        # V6.1: Custom motion file with weighted data
        motion_file = f"{LEGGED_GYM_ROOT_DIR}/motion_data_configs/walking_focused_v6_1.yaml"



class G1MimicPrivCfgPPOV6_1(HumanoidMimicCfgPPO):
    seed = 1
