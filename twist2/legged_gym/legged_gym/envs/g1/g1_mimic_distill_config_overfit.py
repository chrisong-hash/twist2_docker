"""
G1 Mimic Distill Config - OVERFIT TEST

Purpose: Train on tiny dataset (3 clips) to find:
1. Which rewards CAN be maximized (achievable ceiling)
2. Which rewards have fundamental conflicts
3. Baseline for comparison when generalizing

Uses DEFAULT reward weights - only changes the motion file to tiny dataset.
"""
...
class G1MimicPrivCfgOverfit(HumanoidMimicCfg):
    ...
    class rewards(HumanoidMimicCfg.rewards):
        # ================================================================
        # DEFAULT WEIGHTS - unchanged from original
        # Goal: See what ceiling is achievable with simple data
        # ================================================================
    ...
    class domain_rand:
        # DISABLE domain randomization for overfitting test
    ...
    class noise(HumanoidMimicCfg.noise):
        # DISABLE noise for overfitting test
        add_noise = False
    ...
    class motion(HumanoidMimicCfg.motion):
        # DISABLE motion curriculum for overfitting
        ...
        # TINY DATASET for overfitting
        motion_file = f"{LEGGED_GYM_ROOT_DIR}/motion_data_configs/overfit_test.yaml"



class G1MimicPrivCfgPPOOverfit(HumanoidMimicCfgPPO):
    seed = 1
    class runner(HumanoidMimicCfgPPO.runner):
        policy_class_name = 'ActorCriticMimic'
        algorithm_class_name = 'PPO'
        runner_class_name = 'OnPolicyRunnerMimic'
        max_iterations = 50_000  # Shorter - should converge fast on 3 clips
